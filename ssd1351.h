...
#define SSD1351_SPI_PORT hspi5
extern SPI_HandleTypeDef SSD1351_SPI_PORT;

#define SSD1351_RES_Pin       OLED_RES_Pin
#define SSD1351_RES_GPIO_Port OLED_RES_GPIO_Port
#define SSD1351_CS_Pin        OLED_CS_Pin
#define SSD1351_CS_GPIO_Port  OLED_CS_GPIO_Port
